        ...
        <div class="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
          ...
          <div class="space-y-4">
            <div>
              ...
              <input type="text" class="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-white placeholder-white/20 outline-none focus:border-sky-400/50 focus:ring-1 focus:ring-sky-400/20 transition" :placeholder="t('FIRST_RUN.USERNAME_PLACEHOLDER')" />
            </div>
            <div>
              <label class="mb-1 block text-xs text-white/50 font-mono uppercase tracking-widest">{{ t('FIRST_RUN.PASSWORD') }}</label>
              <div class="relative">
                <input :type="showPassword ? 'text' : 'password'" class="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 pr-11 text-white placeholder-white/20 outline-none focus:border-sky-400/50 focus:ring-1 focus:ring-sky-400/20 transition" placeholder="••••••••" />
          ...
          <button class="mt-6 w-full rounded-lg bg-sky-500 py-2.5 font-bold text-white font-sans hover:bg-sky-400 transition cursor-pointer">
